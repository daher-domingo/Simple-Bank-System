    ...
    <div class="container container-card">
        <div class="card shadow-lg bank-card">
            <div class="card-header">
                Depositor's Transaction Records
            </div>
            <div class="card-body p-4">
                <form method="POST" action="main.php?page=deposit">
                    <div class="row mb-4 align-items-center">
                        <div class="col-md-6"></div>
                        <div class="col-md-6 text-end">
                            <div class="input-group shadow-sm text-end">
                                <span class="input-group-text">From</span>
                                <input type="date" class="form-control me-1" name="start_date" value="<?php echo isset($_POST['start_date']); ?>">
                                <span class="input-group-text">To</span>
                                <input type="date" class="form-control me-1" name="end_date" value="<?php echo isset($_POST['end_date']) ?>">
                ...
                <div class="table-responsive">
                    <div class="col-md-4 mb-2">
                        <a href="add_deposit.php" class="btn btn-primary btn-md btn-bank">
                            + Add New Deposit
                        </a>
                    </div>
                    <table class="table table-hover table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT tbl_transaction.trans_date, 
                                         tbl_profile.account_number AS profile_acc_no, 
                                  ...
                                  WHERE tbl_transaction.trans_type = 'Deposit'";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?php echo $record["profile_acc_no"] ?? 'N/A'; ?></td>
                                        <td><?php echo $name; ?></td>
